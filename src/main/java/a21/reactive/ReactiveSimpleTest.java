...
//that is based on the Java 8 type CompletionStage (CompletableFuture). There is a new rx() which is used in a similar manner to async()
...
public class ReactiveSimpleTest {
	...
	public ReactiveSimpleTest() throws InterruptedException, ExecutionException {
		...
		completionStage.thenAccept(r -> this.useIt(r, start));
	...
	private void useIt(Response res, long start) {
